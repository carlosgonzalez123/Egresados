...
public class CorreoRecuperacion {
    ...
    public static Boolean enviarCorreo(Mensaje m) {
        ...
        try{
            ...
            String mensajeHtml = "<i style=\"color:#f00\">Recuperacion de contraseña!</i><br>";
            mensajeHtml += "<b></b>" + "Utiliza este enlace para restablecer tu contraseña" + "<br>";
            mensajeHtml += "<b>Email: </b>" + m.getEmail() + "<br>";
            mensajeHtml += "<b>Sitio: </b> www.soporteufps.co <br>";
